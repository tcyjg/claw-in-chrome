(function () {
  (function () {
    ...
    const __cpAgentIndicatorMessageTypeStopAgent = __cpAgentIndicatorContractMessages.STOP_AGENT || "STOP_AGENT";
    const __cpAgentIndicatorMessageTypeSwitchToMainTab = __cpAgentIndicatorContractMessages.SWITCH_TO_MAIN_TAB || "SWITCH_TO_MAIN_TAB";
    const __cpAgentIndicatorMessageTypeDismissStaticIndicatorForGroup = __cpAgentIndicatorContractMessages.DISMISS_STATIC_INDICATOR_FOR_GROUP || "DISMISS_STATIC_INDICATOR_FOR_GROUP";
    const __cpAgentIndicatorMessageTypeStaticIndicatorHeartbeat = __cpAgentIndicatorContractMessages.STATIC_INDICATOR_HEARTBEAT || "STATIC_INDICATOR_HEARTBEAT";
    const __cpAgentIndicatorRuntimeMessageShowAgentIndicators = __cpAgentIndicatorRuntimeMessageTypes.SHOW_AGENT_INDICATORS || "SHOW_AGENT_INDICATORS";
    const __cpAgentIndicatorRuntimeMessageHideAgentIndicators = __cpAgentIndicatorRuntimeMessageTypes.HIDE_AGENT_INDICATORS || "HIDE_AGENT_INDICATORS";
    const __cpAgentIndicatorRuntimeMessageHideForToolUse = __cpAgentIndicatorRuntimeMessageTypes.HIDE_FOR_TOOL_USE || "HIDE_FOR_TOOL_USE";
    const __cpAgentIndicatorRuntimeMessageShowAfterToolUse = __cpAgentIndicatorRuntimeMessageTypes.SHOW_AFTER_TOOL_USE || "SHOW_AFTER_TOOL_USE";
    const __cpAgentIndicatorRuntimeMessageShowStaticIndicator = __cpAgentIndicatorRuntimeMessageTypes.SHOW_STATIC_INDICATOR || "SHOW_STATIC_INDICATOR";
    const __cpAgentIndicatorRuntimeMessageHideStaticIndicator = __cpAgentIndicatorRuntimeMessageTypes.HIDE_STATIC_INDICATOR || "HIDE_STATIC_INDICATOR";
    ...
    const __cpAgentIndicatorAnimationStylesId = __cpAgentIndicatorDomIds.ANIMATION_STYLES || "claude-agent-animation-styles";
    const __cpAgentIndicatorGlowBorderId = __cpAgentIndicatorDomIds.GLOW_BORDER || "claude-agent-glow-border";
    const __cpAgentIndicatorStopContainerId = __cpAgentIndicatorDomIds.STOP_CONTAINER || "claude-agent-stop-container";
    const __cpAgentIndicatorStopButtonId = __cpAgentIndicatorDomIds.STOP_BUTTON || "claude-agent-stop-button";
    const __cpStaticIndicatorContainerId = __cpAgentIndicatorDomIds.STATIC_CONTAINER || "claude-static-indicator-container";
    const __cpStaticIndicatorChatButtonId = __cpAgentIndicatorDomIds.STATIC_CHAT_BUTTON || "claude-static-chat-button";
    const __cpStaticIndicatorChatTooltipId = __cpAgentIndicatorDomIds.STATIC_CHAT_TOOLTIP || "claude-static-chat-tooltip";
    const __cpStaticIndicatorCloseButtonId = __cpAgentIndicatorDomIds.STATIC_CLOSE_BUTTON || "claude-static-close-button";
    const __cpStaticIndicatorCloseTooltipId = __cpAgentIndicatorDomIds.STATIC_CLOSE_TOOLTIP || "claude-static-close-tooltip";
    ...
    chrome.runtime.onMessage.addListener((l, u, y) => {
      ...
      } else if (l.type === __cpAgentIndicatorRuntimeMessageHideAgentIndicators) {
        c();
        y({
          success: true
        });
      ...
      } else if (l.type === __cpAgentIndicatorRuntimeMessageShowStaticIndicator) {
        d();
        y({
          success: true
        });
      } else if (l.type === __cpAgentIndicatorRuntimeMessageHideStaticIndicator) {
        L();
        y({
          success: true
        });
